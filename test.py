...
def get_args():
    ...
    parser.add_argument('--resume', default='experiments/resnet50/shape=1_color=0_loss=MSE_optim=SGD_interpolate_0.15_trainBN/checkpoints/model_best.pth.tar', type=str,
